...
import { pollWhatsAppMessagesSince } from "../../../../../lib/api";
import type { MessagesSinceResponse } from "../../../../../types/whatsapp-messenger";
...
export function useMessagePolling(
    ...
    const pollForUpdates = useCallback(async () => {
        ...
        try {
            const response = await pollWhatsAppMessagesSince(lastPollTimestamp);
