...
export function useIceServerTest(): IceTestResult & { retest: () => void } {
    console.log("[useIceServerTest] Hook initializing");
    const isFirefox =
        typeof navigator !== "undefined" &&
        navigator.userAgent.toLowerCase().includes("firefox");
    console.log("[useIceServerTest] Browser detection:", {
        isFirefox,
        userAgent:
    ...
    console.log("[useIceServerTest] Initial state:", result);
    ...
    const runTest = useCallback(async () => {
        ...
        console.log("[useIceServerTest] runTest: Starting ICE test");
        ...
        try {
            ...
            console.log("[useIceServerTest] runTest: Creating data channel");
            ...
            console.log("[useIceServerTest] runTest: Creating offer...");
            ...
            console.log("[useIceServerTest] runTest: Gathering complete");
            ...
            console.log("[useIceServerTest] runTest: Cleaning up...");
            if (pc) {
                console.log(
            ...
            console.log("[useIceServerTest] runTest: Cleanup complete");
            isRunningRef.current = false;
        }
    }, [isFirefox]);

    useEffect(() => {
        console.log("[useIceServerTest] useEffect: Running initial test");
        void runTest();
    ...
    console.log("[useIceServerTest] Hook returning result:", result);
    return {
        ...result,
        retest: () => {
            console.log("[useIceServerTest] retest: Manual retest triggered");
            void runTest();
        },
    };
}
